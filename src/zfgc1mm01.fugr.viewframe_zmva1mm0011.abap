*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMVA1MM0011
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMVA1MM0011         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMVA1MM0011'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMVA1MM0011_EXTRACT
TOTAL = ZMVA1MM0011_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMVA1MM0011'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMVA1MM0011-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMVA1MM0011_EXTRACT
TOTAL = ZMVA1MM0011_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMVA1MM0011-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMVA1MM0011'
...
TOTAL = ZMVA1MM0011_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMVA1MM0011-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMVA1MM0011-UPD_FLAG NE SPACE.
